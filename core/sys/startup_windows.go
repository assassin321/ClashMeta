...
const tsTaskName = "ClashMeta Startup"
...
func CreateStartupTask(exePath string) error {
	...
	def.PutProperty("Description", "开机自启 ClashMeta 代理客户端")
...
// DeleteStartupTask removes the ClashMeta startup task.
