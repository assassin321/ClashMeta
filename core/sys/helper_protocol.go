...
const (
	HelperServiceName = "ClashMetaHelper"
	HelperDisplayName = "ClashMeta Helper Service"
	HelperDescription = "为 ClashMeta 提供高权限能力：TUN 启动、Wintun 安装、核心文件替换、权限修复"

	// 固定 Named Pipe 名称
	HelperPipeName = `\\.\pipe\ClashMeta.Helper`
)
