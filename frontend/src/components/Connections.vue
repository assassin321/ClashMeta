...
const filterMode = ref(localStorage.getItem('clashmeta_connFilter') || 'all');
...
watch(filterMode, (v) => { localStorage.setItem('clashmeta_connFilter', v); nextTick(updateConnSlider); });
